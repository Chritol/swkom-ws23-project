...
@Service
public abstract class UpdateDocument200ResponseMapper implements BaseMapper<DocumentsDocument, UpdateDocument200Response> {
    @Autowired
    ...
    abstract public DocumentsDocument dtoToEntity(UpdateDocument200Response dto);
    ...
    abstract public UpdateDocument200Response entityToDto(DocumentsDocument entity);
